...
void buildObjects() {
	...
	//attempt to read in the roof obj file
...
void display() {
	...
	GLfloat columnColor[] = { 1.0f, 0.0f, 1.0f, 1.0f }; // color to draw with -- currently magenta
	...
	//Draw a tiger...
	mat4x4_translate(translationMatrix, 0.0f, -0.5f, 0.0f);
	glBindVertexArray(vertexBuffers[1]);
	glBindBuffer(GL_ARRAY_BUFFER, arrayBuffers[1]);
	glUniformMatrix4fv(modelMatrixLocation, 1, false, (const GLfloat*)translationMatrix);
...
int main(int argCount, char* argValues[]) {
	...
	window = glfwStartUp(argCount, argValues, "Project 1 Collin Creps - Draw The Scene");
